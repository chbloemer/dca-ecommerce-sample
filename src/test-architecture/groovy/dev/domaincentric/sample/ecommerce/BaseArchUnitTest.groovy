...
import dev.domaincentric.sample.ecommerce.sharedkernel.marker.port.in.InputPort
...
import dev.domaincentric.sample.ecommerce.sharedkernel.marker.tactical.Specification as DomainSpecification
...
abstract class BaseArchUnitTest extends Specification {
  ...
  "reside in infrastructure implementation", { JavaClass javaClass ->
    ...
    return packageName.startsWith("dev.domaincentric.sample.ecommerce.infrastructure.")
  }
  )
  ...
  protected static final String BASE_PACKAGE = "dev.domaincentric.sample.ecommerce"
  ...
  protected Map<String, BoundedContext> discoverBoundedContextPackages() {
    ...
    allClasses.each { javaClass ->
      String packageName = javaClass.getPackageName()
      // Get the root context package (e.g., dev.domaincentric.sample.ecommerce.product from dev.domaincentric.sample.ecommerce.product.domain.model)
   ...
   * E.g., "dev.domaincentric.sample.ecommerce.product.domain.model" -> "dev.domaincentric.sample.ecommerce.product"
   *
   ...
   *
   * @return list of package patterns like "dev.domaincentric.sample.ecommerce.product.."
   */
   ...
   *
   * @return array of patterns like "dev.domaincentric.sample.ecommerce.product.adapter.incoming..", plus
