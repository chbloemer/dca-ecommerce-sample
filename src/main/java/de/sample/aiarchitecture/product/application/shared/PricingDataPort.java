 ...
 *
 * <p>Since pricing is managed by the Pricing bounded context, the Product context defines this port
 * for its pricing data needs. This port is implemented by an outgoing adapter that delegates to the
 * Pricing context's Open Host Service.
 *
 * <p><b>Hexagonal Architecture:</b> This is a secondary/driven port that defines what the Product
 * application layer needs from the Pricing context.
 */
public interface PricingDataPort extends OutputPort {
   ...
   */
  record PriceData(ProductId productId, Money currentPrice) {}
