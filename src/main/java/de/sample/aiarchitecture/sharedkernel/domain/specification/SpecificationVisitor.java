 ...
 *
 * <p>Adapters implement this to convert a domain {@link CompositeSpecification} into a persistence-
 * or transport-specific representation (e.g., JPA Specification, Querydsl predicate, Mongo filter,
