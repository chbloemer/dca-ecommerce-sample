 ...
 *
 * <p>This event is raised during registration when the anonymous user's UserId is linked to their
 * new account.
 *
 * <p>This allows other bounded contexts to know that:
 *
 * <ul>
 *   <li>The UserId now represents a registered user
 *   <li>Resources associated with this UserId (like carts) now belong to an account
 * </ul>
 *
