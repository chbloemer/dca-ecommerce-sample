 ...
 *
 * <p>This interface abstracts password hashing, allowing domain objects to work with passwords
 * without knowing the specific hashing algorithm. Implementations reside in the adapter layer.
 *
 * <p><b>Security Requirements:</b>
 *
 * <ul>
 *   <li>Use BCrypt or another secure hashing algorithm
 *   <li>Include random salt with each hash
 *   <li>Use timing-safe comparison to prevent timing attacks
 * </ul>
 *
...
public interface PasswordHasher {
   ...
   *
   * <p>The returned hash includes a random salt, so hashing the same password twice will produce
   * different results.
   *
