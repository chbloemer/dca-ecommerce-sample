 ...
 * de.sample.aiarchitecture} package tree to discover all bounded contexts (product, cart, portal)
 * and shared kernel components.
 */
@SpringBootApplication(scanBasePackages = "de.sample.aiarchitecture")
@org.springframework.data.jpa.repository.config.EnableJpaRepositories(
    basePackages = "de.sample.aiarchitecture")
