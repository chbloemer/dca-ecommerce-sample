 ...
 *
 * <p>Cart context defines its own port for article data needs. This port is implemented by an
 * outgoing adapter that delegates to the Product and Inventory contexts' Open Host Services.
 *
 * <p><b>Hexagonal Architecture:</b> This is a secondary/driven port that defines what the Cart
 * application layer needs from other contexts (Product for name/price, Inventory for stock
 * information).
 */
