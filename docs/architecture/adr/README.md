...
| [ADR-034](adr-034-transaction-boundary-and-remote-ports.md) | Transaction boundary — `@Transactional` for local use cases, `UnitOfWork` when remote ports are involved | Accepted |
