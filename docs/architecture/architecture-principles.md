...
**Characteristics:**
- Transactional (`@Transactional`, or `TransactionBoundary.run` around save + publish when the use case also calls remote-capable ports — ADR-034)
